...
urlpatterns = [
    ...
    path('<int:pk>/timelog/last-month', LastMonthTimelogView.as_view(), name='get_last_month_timelog'),
    path('<int:pk>/timelog/top20', LastMonthTopTimelogView.as_view(), name='get_top_last_month_timelog'),
